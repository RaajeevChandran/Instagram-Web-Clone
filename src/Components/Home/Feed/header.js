  ...
  return (
    <div className="header">
      <div className="logo">
          ...
          <img src={require("../../../Assets/instalogo.png")} alt="" className="logo-img"/>
          
      </div>
      <div className="search">
        <div className="input-wrapper">
          <input id="stuff" className="search-input" placeholder="Search" />
      ...
      <div className="icons">
        ...
        <div className="icon-container" style={{ margin: "10px" }}></div>
      </div>
    </div>
  );
};
